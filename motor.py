...
class MotorAFND:
    ...
    def fecho_epsilon(self, mapa_transicoes, estados):
    ...
    def processar_palavra(self, afd, mapa_transicoes, palavra):
        ...
        estados_atuais = self.fecho_epsilon(mapa_transicoes, afd.estados_iniciais)
        ...
        for simbolo in palavra: # Laço de processamento da palavra, consumo de 1 char
            ...
            estados_atuais = self.fecho_epsilon(mapa_transicoes, proximos_estados)
...
class MotorAP:
    ...
    def fecho_epsilon(self, mapa_transicoes, configs_iniciais):
    ...
    def processar_palavra(self, afd, mapa_transicoes, palavra):
        ...
        configs_atuais = self.fecho_epsilon(mapa_transicoes, configs_atuais) # Aplica lambdas iniciais
        ...
        for simbolo in palavra:
            ...
            configs_atuais = self.fecho_epsilon(mapa_transicoes, proximas_configs) # Lambdas apóes consumir char
...
# Garantem que o main.py continue chamando os exatos nomes definidos na documentação original,
# mas que o programa escale por debaixo dos panos de forma orientada a objetos polimórfica.
def get_motor(afd):
